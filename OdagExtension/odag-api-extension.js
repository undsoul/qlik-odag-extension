    ...
    return {
        ...
        paint: function($element, layout) {
            ...
            if (isDynamicView && odagConfig.odagLinkId) {
                ...
                // Track first-load flag to gate the v9.2.8 "fresh tab → auto-generate" behavior.
                // v9.2.11: In native Qlik mobile app the WebView is killed and recreated every
                // time the app returns from background (see qsmlog "Qlik Sense Mobile started"
                // restarts), which wipes sessionStorage and falsely re-triggers fresh-tab regen.
                // Use localStorage there so the flag survives WebView restart. Browser keeps
                // sessionStorage so v9.2.8's per-tab semantics still work.
